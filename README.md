...
- Новая задача появляется в начале списка с иконкой ❌ (не выполнена).
 ...
 <img width="1397" height="565" alt="Image" src="https://github.com/user-attachments/assets/a599395c-5519-490b-b18b-8ecdd38ca6a0" />
...
```
<img width="1378" height="544" alt="Image" src="https://github.com/user-attachments/assets/07a7f7b3-da4d-4148-b69a-9dcc14143856" />
